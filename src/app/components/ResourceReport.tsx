...
export default function ResourceReport({ kind, id }: Props) {
  ...
  return (
    <div ref={containerRef} className="relative inline-block">
      ...
      {open && (
        <div className="absolute right-0 z-50 mt-1 w-72 rounded-xl border border-[color:rgb(var(--glass-border)/0.35)] bg-white dark:bg-[color:rgb(var(--card))] p-3 text-sm shadow-2xl">
          {err && (
